...
const date = required("date-and-time");
...
const DefaultContent = new moongoose.Model("defaultContent", defaultContentSchema)
...
const homePageDefaultContent = new DefaultContent({
  content: "Amidst the hustle and bustle of the city, I found solace in the small things. The sound of rain tapping against the window, the smell of fresh coffee in the morning, and the sight of a rainbow after a storm. It's easy to get caught up in the chaos, but sometimes all it takes is a moment of mindfulness to appreciate the beauty around us.";
})

const aboutPageDefaultContent = new DefaultContent({
  content:  "At our company, we're passionate about providing our customers with high-quality products and services. We believe that our success is directly tied to the satisfaction of our customers, so we work hard every day to exceed their expectations. Our team is made up of experienced professionals who are committed to delivering exceptional results, and we're always striving to improve our processes and refine our approach. Whether you're a new customer or a longtime partner, you can count on us to provide the support and solutions you need to achieve your goals. Thank you for choosing us as your partner in success!";
})

const contactPageDefaultContent = new DefaultContent({
